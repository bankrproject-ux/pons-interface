...
export default function TokenCard({ token }) {
  ...
  return (
    <Link href={`/token/${token.address}`}>
      <div className="glass rounded-2xl overflow-hidden group relative transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02]">
          ...
          {!token.graduated && (
            <div className="mb-6">
              ...
              <div className="relative h-3 bg-white/5 rounded-full overflow-hidden">
                <div
                  className="absolute inset-y-0 left-0 bg-gradient-to-r from-accent-orange to-accent-pink rounded-full transition-all duration-1000"
                  style={{ 
